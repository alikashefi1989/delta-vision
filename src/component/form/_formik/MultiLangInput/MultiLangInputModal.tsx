...
class MultiLangInputModalComponent extends React.Component<IProps, IState> {
    state = {
                            ...
                            <>
                                <Modal.Body>
                                    <div className="row">
                                        ...
                                        {!this.props.readOnly && <div className="col-md-12">
                                            <FormControl
...
export const MultiLangInputModal = connect(state2props, dispatch2props)(MultiLangInputModalComponent);
