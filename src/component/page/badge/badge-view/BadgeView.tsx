...
interface IState extends IStateBaseDetail<IBadge> {}
interface IProps {
...
class BadgeViewComponent extends BaseDetail<
    IBadge,
    TBadgeCreate,
    TBadgeUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Badge Information</p>
                </div>
...
export const BadgeView = connect(
    state2props,
    dispatch2props
)(BadgeViewComponent);
