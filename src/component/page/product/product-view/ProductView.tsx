...
interface IState extends IStateBaseDetail<IProduct> {}
interface IProps {
...
class ProductViewComponent extends BaseDetail<
    IProduct,
    TProductCreate,
    TProductUpdate,
    IProps,
...
> {
    ...
    get defaultLangCode(): string {
        return this.props.language.defaultLanguage?.country || '';
    }
            ...
            >
                ...
                <div className="col-6">
                    ...
                    <div className="field-container align-items-start">
                        ...
                        <span className="pt-2">
                            {this.state.fetchData?.description.en}
                        </span>{' '}
                    </div>
                </div>
                <div className="col-6">
                    <div className="field-container ">
                        ...
                        <span className="">
                            {this.state.fetchData?.name?.ar}
                        </span>{' '}
                    </div>
                    <div className="field-container align-items-start">
                        <p className="label- ">Ar Description </p>{' '}
                        <span className="pt-2">
                            {this.state.fetchData?.description.ar}
                        </span>{' '}
                    </div>
                </div>
                {/* <div className="field-container "><p className="label- ">Brand </p> <span className=" text-info">{this.state.fetchData?.brand}</span> </div> */}
            </div>
        );
    }
