...
interface IState extends IStateBaseDetail<IArea> {}
interface IProps {
...
class AreaViewComponent extends BaseDetail<
    IArea,
    TAreaCreate,
    TAreaUpdate,
    IProps,
...
export const AreaView = connect(state2props, dispatch2props)(AreaViewComponent);
