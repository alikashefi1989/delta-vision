...
interface IState extends IStateBaseDetail<IPurchaseReturn> {}
interface IProps {
...
class PurchaseReturnViewComponent extends BaseDetail<
    IPurchaseReturn,
    TPurchaseReturnCreate,
    TPurchaseReturnUpdate,
    IProps,
            ...
            >
                ...
                <div className="col-6">
                    <div className="field-container ">
                        <p className="label- ">Purchase Return ID </p>{' '}
            ...
            <div className="template-box animated fadeInDown min-h-150px p-0">
                <div className="row detail-container">
                    ...
                    {this.renderRelatedList([
                        {
                            title: 'purshaseReturn information',
                            id: 'item-information',
                        },
                    ])}
...
export const PurchaseReturnView = connect(
    state2props,
    dispatch2props
