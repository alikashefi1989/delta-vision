...
interface IState extends IStateBaseDetail<IWarehouse> {}
interface IProps {
...
class WarehouseViewComponent extends BaseDetail<
    IWarehouse,
    TWarehouseCreate,
    TWarehouseUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Warehouse Information</p>
                </div>
...
export const WarehouseView = connect(
    state2props,
    dispatch2props
