...
interface IState extends IStateBaseDetail<IVariation> {}
interface IProps {
...
class VariationViewComponent extends BaseDetail<
    IVariation,
    TVariationCreate,
    TVariationUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Variation Information</p>
                </div>
...
export const VariationView = connect(
    state2props,
    dispatch2props
