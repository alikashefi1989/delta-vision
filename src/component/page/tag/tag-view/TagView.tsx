...
interface IState extends IStateBaseDetail<ITag> {}
interface IProps {
...
class TagViewComponent extends BaseDetail<
    ITag,
    TTagCreate,
    TTagUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Tag Information</p>
                </div>
                ...
                <div className="field-container ">
                    ...
                    <span className="">{this.state.fetchData?.title?.en}</span>{' '}
                </div>
                <div className="field-container ">
                    <p className="label- ">Ar Name </p>{' '}
                    <span className="">{this.state.fetchData?.title?.ar}</span>{' '}
                </div>
            </div>
        );
    }
            ...
            <div className="template-box animated fadeInDown min-h-150px p-0">
                <div className="row detail-container">
                    ...
                    {this.renderRelatedList([
                        { title: 'tags information', id: 'item-information' },
...
export const TagView = connect(state2props, dispatch2props)(TagViewComponent);
