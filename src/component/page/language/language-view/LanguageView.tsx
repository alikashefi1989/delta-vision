...
interface IState extends IStateBaseDetail<ILanguage> {}
interface IProps {
...
class LanguageViewComponent extends BaseDetail<
    ILanguage,
    TLanguageCreate,
    TLanguageUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Language Information</p>
                </div>
...
export const LanguageView = connect(
    state2props,
    dispatch2props
