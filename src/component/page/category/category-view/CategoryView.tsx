...
interface IState extends IStateBaseDetail<ICategory> {}
interface IProps {
...
class CategoryViewComponent extends BaseDetail<
    ICategory,
    TCategoryCreate,
    TCategoryUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Category Information</p>
                </div>
...
export const CategoryView = connect(
    state2props,
    dispatch2props
