...
interface IState extends IStateBaseDetail<IPurshase> {}
interface IProps {
...
class PurshaseViewComponent extends BaseDetail<
    IPurshase,
    TPurshaseCreate,
    TPurshaseUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Purshase Information</p>
                </div>
...
export const PurshaseView = connect(
    state2props,
    dispatch2props
)(PurshaseViewComponent);
