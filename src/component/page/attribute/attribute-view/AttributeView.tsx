...
interface IState extends IStateBaseDetail<IAttribute> {}
interface IProps {
...
class AttributeViewComponent extends BaseDetail<
    IAttribute,
    TAttributeCreate,
    TAttributeUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Attribute Information</p>
                </div>
...
export const AttributeView = connect(
    state2props,
    dispatch2props
