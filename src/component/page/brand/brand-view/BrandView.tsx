...
interface IState extends IStateBaseDetail<IBrand> {}
interface IProps {
...
class BrandViewComponent extends BaseDetail<
    IBrand,
    TBrandCreate,
    TBrandUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Brand Information</p>
                </div>
...
export const BrandView = connect(
    state2props,
    dispatch2props
)(BrandViewComponent);
