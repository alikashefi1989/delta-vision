...
interface IState extends IStateBaseDetail<IAdjustment> {}
interface IProps {
...
class AdjustmentViewComponent extends BaseDetail<
    IAdjustment,
    TAdjustmentCreate,
    TAdjustmentUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Adjustment Information</p>
                </div>
...
export const AdjustmentView = connect(
    state2props,
    dispatch2props
