...
class ShrinkComponent<IProps, IState> extends MainStructureComponent {
    bodyRendererFunction(): JSX.Element {
        return (
            <>
                <div className="container shrink-wrapper">
...
export const Shrink = connect(state2props, dispatch2props)(ShrinkComponent);
