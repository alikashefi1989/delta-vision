...
interface IState extends IStateBaseDetail<ICoupon> {}
interface IProps {
...
class CouponViewComponent extends BaseDetail<
    ICoupon,
    TCouponCreate,
    TCouponUpdate,
    IProps,
        ...
        return (
            <div className="content-container " id="item-information">
                <div className="title-container">
                    <p className="text-capitalize">Coupon Information</p>
                </div>
...
export const CouponView = connect(
    state2props,
    dispatch2props
)(CouponViewComponent);
